...
- [requirecloud/gha-workflows](https://github.com/requirecloud/gha-workflows) -  (5 days ago)
...
- [Potential fix for code scanning alert no. 3: Workflow does not contain permissions](https://github.com/druidfi/docker-images/pull/95) - `MERGED` 4 weeks ago - [druidfi/docker-images](https://github.com/druidfi/docker-images): General use Docker images for projects
