...
- [Add Reader::eject() to generate a static settings.php](https://github.com/druidfi/omen/pull/17) - `OPEN` today - [druidfi/omen](https://github.com/druidfi/omen): Read the clouds and detect Drupal environment
