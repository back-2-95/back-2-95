...
- [druidfi/stonehenge](https://github.com/druidfi/stonehenge) ([5.3.0](https://github.com/druidfi/stonehenge/releases/tag/5.3.0), 6 days ago) - Multi-project local development environment &amp; toolset on Docker
...
- [Add Reader::eject() to generate a static settings.php](https://github.com/druidfi/omen/pull/17) - `OPEN` 4 days ago - [druidfi/omen](https://github.com/druidfi/omen): Read the clouds and detect Drupal environment
