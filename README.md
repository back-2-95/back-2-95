...
- [SymfonyCasts/tailwind-bundle](https://github.com/SymfonyCasts/tailwind-bundle) ([v0.5.1](https://github.com/SymfonyCasts/tailwind-bundle/releases/tag/v0.5.1), 1 week ago) - Delightful Tailwind Support for Symfony &#43; AssetMapper
- [dunglas/doctrine-json-odm](https://github.com/dunglas/doctrine-json-odm) ([v1.4.1](https://github.com/dunglas/doctrine-json-odm/releases/tag/v1.4.1), 3 weeks ago) - An object document mapper for Doctrine ORM using JSON types of modern RDBMS.
...
- [1.1.0 features](https://github.com/druidfi/mysqldump-php/pull/38) - `OPEN` 4 days ago - [druidfi/mysqldump-php](https://github.com/druidfi/mysqldump-php): PHP version of mysqldump cli that comes with MySQL
