...
- [Add Rector](https://github.com/druidfi/mysqldump-php/pull/72) - `MERGED` 4 weeks ago - [druidfi/mysqldump-php](https://github.com/druidfi/mysqldump-php): PHP version of mysqldump cli that comes with MySQL
