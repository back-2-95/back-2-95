...
- [Fix issue #35](https://github.com/druidfi/mysqldump-php/pull/58) - `OPEN` 1 day ago - [druidfi/mysqldump-php](https://github.com/druidfi/mysqldump-php): PHP version of mysqldump cli that comes with MySQL
...
- [Set forceAuthn true](https://github.com/back-2-95/onelogin-saml-bundle/pull/1) - `OPEN` 2 days ago - [back-2-95/onelogin-saml-bundle](https://github.com/back-2-95/onelogin-saml-bundle): OneLogin SAML Symfony Bundle

- [Potential fix for code scanning alert no. 1: Workflow does not contain permissions](https://github.com/druidfi/mysqldump-php/pull/56) - `MERGED` 3 days ago - [druidfi/mysqldump-php](https://github.com/druidfi/mysqldump-php): PHP version of mysqldump cli that comes with MySQL

- [Add new compression options](https://github.com/druidfi/mysqldump-php/pull/55) - `MERGED` 3 days ago - [druidfi/mysqldump-php](https://github.com/druidfi/mysqldump-php): PHP version of mysqldump cli that comes with MySQL

- [Mautic 6 images](https://github.com/druidfi/mautic/pull/4) - `OPEN` 6 days ago - [druidfi/mautic](https://github.com/druidfi/mautic): DruidXP variant for Mautic
